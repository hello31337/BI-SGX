...
CONFIG_CLEAN_FILES = run-server run-client
...
am_client_OBJECTS = isv.$(OBJEXT) sgx_detect_linux.$(OBJEXT) \
	sgx_stub.$(OBJEXT) quote_size.$(OBJEXT) error_print.$(OBJEXT) \
	$(am__objects_1)
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(srcdir)/run.in $(top_srcdir)/build-aux/sgx_app.am compile \
...
ACLOCAL = ${SHELL} /home/aos/sgx-rel/sgx-ra-sample/missing aclocal-1.15
AGENT_CURL_SRC = agent_curl.cpp
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/aos/sgx-rel/sgx-ra-sample/missing autoconf
AUTOHEADER = ${SHELL} /home/aos/sgx-rel/sgx-ra-sample/missing autoheader
AUTOMAKE = ${SHELL} /home/aos/sgx-rel/sgx-ra-sample/missing automake-1.15
AWK = gawk
CC = gcc
...
LIBS_HW_SIMU = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/aos/sgx-rel/sgx-ra-sample/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
OPENSSL_CPPFLAGS = -I/opt/openssl/1.1.0i/include
OPENSSL_LDFLAGS = -L/opt/openssl/1.1.0i/lib
...
STRIP = 
VERSION = 1.0
abs_builddir = /home/aos/sgx-rel/sgx-ra-sample
abs_srcdir = /home/aos/sgx-rel/sgx-ra-sample
abs_top_builddir = /home/aos/sgx-rel/sgx-ra-sample
abs_top_srcdir = /home/aos/sgx-rel/sgx-ra-sample
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/aos/sgx-rel/sgx-ra-sample/install-sh
...
#	-I/opt/openssl/1.1.0i/include $(am__empty)
...
client_SOURCES = isv.cpp sgx_detect_linux.c sgx_stub.c quote_size.c error_print.cpp \
	$(common)
...
client_LDFLAGS = $(AM_LDFLAGS) -L/opt/openssl/1.1.0i/lib
...
sp_LDFLAGS = $(AM_LDFLAGS) -L/opt/openssl/1.1.0i/lib 
mrsigner_LDFLAGS = $(AM_LDFLAGS) -L/opt/openssl/1.1.0i/lib
client_LDADD = -l$(SGX_URTS_LIB) -lsgx_ukey_exchange -l$(SGX_UAE_SERVICE_LIB) \
	-lcrypto -l:libsgx_capable.a -lpthread -ldl -lmysqlcppconn
...
policy: mrsigner policy.in Enclave.signed.so
	...
	sed -e "s^@MRSIGNER@^`./mrsigner enclave_sigstruct_raw`^" policy.in > policy
