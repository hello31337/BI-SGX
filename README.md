...
Or you can also execute these 3 commands at once by executing following command:
...
See at [BI-SGX's wiki](https://github.com/hello31337/BI-SGX/wiki) for interpreter's specifications and grammers.
